      ...
      if(!$classes) {
        ...
        foreach($classes as $class_id) {
          ...
          echo '<div class="class"> 
            ...
            <div><strong>Code Or Subject name</strong><br/> : <span class="code">'.$code.'</span></div> 
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : 15CS51T OR Subject Name Ex : SOFTWARE ENGINNERING">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 339CS18001)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 339CS18033)">
